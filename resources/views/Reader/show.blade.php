...
@section('content')
    ...
    <div id="books-elements">
        ...
        <div class="coloumn">
            <div class="books-elements-head-title">
                <h4 class="head">all user posts </h4>
            </div>
            <div class="book-block">
        ...
        <div class="coloumn">
            <div class="books-elements-head-title">
                <h4 class="head">user information</h4>
            </div>
            <div class="personal-info">
                <div class="personal-info-form">
                        <div class="form-group">
                            ...
                            <span class="badge alert alert-primary text-capitalize">name:</span>
                            <span class="text-black-50">{{$personal_info->name}}</span>
                        </div>
                        <div class="form-group">
                            {{--<label for="email">email</label>
                            <input type="text"name="email"value="{{$personal_info->email}}"id="email"class="form-control"readonly>--}}
                            <span class="badge alert alert-primary text-capitalize">email:</span>
                            <span class="text-black-50">{{$personal_info->email}}</span>
                        </div>
                        <div class="form-group">
                            {{--<label for="phone">phone:</label>--}}
                            <span class="badge alert alert-primary text-capitalize">phone:</span>
                            @if($personal_info->phone_status==1)
                                {{--<input type="text"name="phone"value="{{$personal_info->phone}}"id="phone"class="form-control">--}}
                                <span class="badge text-dark">{{$personal_info->phone}}</span>
                                @else
                                <span class="badge text-capitalize">not available</span>
                                @endif
